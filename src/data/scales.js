  ...
  mature: {
    ...
    mechanisms: [
      ...
      { id: "suppression", name: "억제", items: [
        ...
        { id: "su3", text: "힘든 상황에서 '나중에 충분히 생각하겠다'고 하고 일단 넘어간다." },
      ]},
  ...
  neurotic: {
    ...
    mechanisms: [
      { id: "rationalization", name: "합리화", items: [
        ...
        { id: "r2", text: "내가 한 행동에는 사실 충분한 이유가 있다고 설명하는 편이다." },
      ...
      { id: "repression", name: "억압", items: [
        { id: "re1", text: "불쾌했던 일들이 나중에 생각하려 해도 잘 기억나지 않는다." },
        { id: "re2", text: "과거의 힘든 기억이 어느 순간부터 자연스럽게 떠오르지 않게 된다." },
      ]},
  ...
  immature: {
    ...
    mechanisms: [
      ...
      { id: "passive_aggression", name: "수동적 공격", items: [
        { id: "pa1", text: "화가 나도 직접 말하지 않고 비협조적으로 행동한다." },
        { id: "pa2", text: "불만이 있을 때 말로 하지 않고 늑장을 부리거나 잊어버리곤 한다." },
        { id: "pa3", text: "부탁을 거절하기 어려울 때 마지못해 하면서 실수를 반복한다." },
      ]},
      ...
      { id: "regression", name: "퇴행", items: [
        { id: "rg1", text: "매우 힘들거나 스트레스를 받으면 어린 시절처럼 행동하게 된다." },
        { id: "rg2", text: "위기 상황에서 평소보다 훨씬 의존적이 되거나 유치하게 반응한다." },
      ]},
      ...
      { id: "splitting", name: "분열", items: [
        ...
        { id: "sp2", text: "좋아하던 사람이 실망을 주면 갑자기 완전히 나쁜 사람으로 느껴진다." },
      ]},
    ],
  },
};
